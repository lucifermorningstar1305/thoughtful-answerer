...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", "-i", required=True, type=str, help="the huggingface model id")
    ...
    ques_tokenizer = transformers.AutoTokenizer.from_pretrained("sentence-transformers/multi-qa-mpnet-base-dot-v1",
                                                                                  do_lower_case=True)
    ques_encoder = transformers.AutoModel.from_pretrained("sentence-transformers/multi-qa-mpnet-base-dot-v1").to(device)
