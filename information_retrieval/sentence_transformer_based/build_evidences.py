...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_id", "-i", required=True, type=str, help="the hugging face model_id")
    ...
    ctx_tokenizer = transformers.AutoTokenizer.from_pretrained(args.model_id, 
                                                                                do_lower_case=True)
    
    ctx_encoder = transformers.AutoModel.from_pretrained(args.model_id,
